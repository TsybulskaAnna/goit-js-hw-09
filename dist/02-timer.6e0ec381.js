...
var userChosenTime = null;
var startBtn = document.querySelector("[data-start]");
startBtn.addEventListener("click", startCount);
startBtn.disabled = true;
var timer = (0, _flatpickr.default)("input#datetime-picker", {
  enableTime: true,
  time_24hr: true,
...
function startCount() {
  ...
  var timeDelta = userChosenTime.getTime() - currentTime.getTime();
...
function checkDate(userTime) {
  ...
  if (timeDelta < 0) {
    _notiflixNotifyAio.Notify.failure("Please choose a date in future", {
      timeout: 2000,
